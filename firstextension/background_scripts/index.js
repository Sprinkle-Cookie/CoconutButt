 ...
 * scripts). */
var expressions = __webpack_require__(7);
...
var sanitizeHtml = __webpack_require__(11);
...
var TOP4555_HU = ["nem","az","hogy","és","egy","van","ez","is","meg","de","csak","mi","ha","én","azt","vagy","volt","igen","itt","kell","el","már","ne","te","még","ki","mit","jó","vagyok","ezt","most","tudom","úgy","miért","mint","akkor","jól","lesz","nincs","nagyon","minden","mert","be","rendben","le","sem","amit","olyan","ott","így","tudod","fel","nekem","volna","oké","maga","majd","valami","hát","lehet","hol","talán","mindig","köszönöm","semmi","kis","aki","hé","neki","gyerünk","neked","uram","amikor","szóval","hiszem","ide","valamit","ami","vissza","nagy","őket","tudja","elég","fog","rá","tényleg","lenne","milyen","egész","mr","igaz","ember","biztos","vele","vannak","vagyunk","ma","sajnálom","ilyen","gyere","mikor","két","nos","persze","túl","sok","azért","történt","na","értem","szia","valaki","aztán","mondta","kicsit","ahogy","engem","velem","se","pedig","mondtam","arra","voltam","új","nézd","mindent","ugye","más","akarsz","kérem","semmit","benne","erre","kellett","veled","jobb","akarok","ezért","soha","akarom","menj","kéne","baj","mindenki","akar","rám","senki","több","szép","nap","legyen","magát","kérlek","őt","át","szerintem","ezek","pár","istenem","miatt","rossz","emberek","várj","első","minket","este","mintha","együtt","ja","téged","láttam","oda","tudok","után","igazán","szerint","mondja","innen","egyszer","róla","hogyan","dolog","sosem","mondd","ön","újra","tudtam","másik","rajta","amíg","tessék","érted","hittem","kellene","megyek","apa","figyelj","lenni","elnézést","akartam","oh","három","annyira","isten","egyik","gondoltam","jobban","épp","jön","inkább","tud","magam","alatt","saját","lett","megy","néhány","ezzel","magad","mind","egyetlen","úr","teljesen","legjobb","anya","haver","ebben","vége","hozzá","akarod","dr","mire","tűnik","mielőtt","tovább","egyedül","honnan","voltál","ők","szó","menjünk","csinálsz","hadd","mondani","micsoda","holnap","akik","kösz","komolyan","szeretném","idő","nekünk","nélkül","ahol","azok","előtt","áll","nő","mondom","ben","akarja","pontosan","voltak","rád","látom","megvan","tudsz","ennek","gyorsan","látni","leszek","megint","remélem","tudjuk","egyet","pont","tudni","beszélni","remek","igazi","jött","először","ti","tehát","fogja","össze","utolsó","nehéz","nekik","fogok","kész","azzal","lány","haza","erről","ugyan","sokat","menni","hagyd","örülök","francba","hallottam","sincs","mégis","magának","szeretnék","azonnal","ennyi","helló","ezen","csinálni","hanem","nagyszerű","később","állj","mondtad","fogom","tetszik","érdekel","kedves","többet","srácok","halott","fogsz","legalább","néha","bele","mennem","éves","add","miről","fiam","érzem","férfi","végre","ideje","meghalt","fontos","azon","perc","abba","látod","éve","sokkal","szeretlek","öt","akit","összes","apám","reggel","gond","hova","gondolom","pénzt","es","tenni","szükségem","néz","többé","mivel","attól","annak","tegnap","arról","világ","ok","szeretem","fiú","hely","john","beszélsz","megyünk","múlva","helyzet","boldog","vagytok","ment","ezeket","nézze","tedd","következő","barátom","szabad","óra","éppen","beszél","valaha","jöjjön","történik","jelent","dolgot","aha","egyáltalán","hová","képes","neve","fickó","kurva","találkozunk","régi","majdnem","mindjárt","fél","óta","míg","szerinted","maradj","mész","nézz","segíteni","biztosan","mennyi","számít","öreg","abban","készen","mondott","gyönyörű","enyém","között","kérek","ellen","velünk","hülye","hozzám","négy","emlékszel","valakit","előbb","király","fiúk","légy","köszi","leszel","folyik","kibaszott","ahhoz","úgyhogy","drágám","jöttem","gondolsz","addig","éjjel","embert","viszlát","tőlem","érte","dolgokat","emlékszem","ég","gondolod","élet","főnök","bármit","fogd","tiszta","csinál","tőle","munka","mondod","vicces","nyugi","tettem","év","fognak","beszélek","vigyázz","bár","akár","dolgok","pénz","vedd","kapitány","napot","sam","amint","mond","bocs","tudják","vettem","mennyire","eddig","ilyet","menjen","bármi","fogunk","gyerek","fenébe","tökéletes","anyám","életben","helyes","egyszerűen","való","jelenti","szüksége","tudta","teljes","akart","sikerült","jövök","valóban","annyi","utána","helyet","velük","uraim","otthon","valószínűleg","reggelt","sose","hét","hosszú","szépen","miután","tart","hat","mióta","szól","elment","valójában","hiszed","belőle","természetesen","ezelőtt","fogod","halló","jaj","közel","michael","mást","maguk","találtam","tett","igaza","bocsánat","jár","csináld","belül","marad","melyik","nevem","pillanat","várjon","felé","igazából","tette","többi","ötlet","életem","ismerem","működik","igazad","srác","üdv","kettő","érti","hangzik","fehér","él","segítség","elő","jössz","ajtót","amerikai","mozgás","ügynök","alig","aggódj","egymást","látta","édes","rólam","magával","beteg","láttad","hívják","fekete","bennem","végül","ehhez","hamarosan","kérdés","gyerekek","szar","rohadt","apád","vár","szívesen","ebből","elnök","voltunk","fene","időt","alá","muszáj","lennék","ügy","őrült","akarnak","annyit","maradt","ért","rosszul","egyszerű","mellett","sokáig","jönni","hány","előre","érdekes","embereket","hiszi","második","tudunk","amire","különleges","gondolja","nézel","csodálatos","önnek","lennie","jézusom","viszont","dolgozik","komoly","mondják","akinek","nálam","nincsenek","percet","keresztül","minek","eltűnt","kapcsolatban","igazság","úton","munkát","furcsa","fegyvert","mindegy","múlt","héten","bent","erős","egyre","nagyobb","tőled","azokat","kicsim","tíz","probléma","valahol","csináltam","akarta","mindenkinek","hatalmas","kicsi","szent","adj","apja","különben","doktor","jönnek","szívem","lesznek","ennyire","vagyis","kaptam","segít","közben","rendőrség","szükségünk","dolgozni","legnagyobb","könnyű","máris","halál","ér","gyilkos","mondok","esetleg","bárki","lehetséges","kívül","fiatal","tele","szörnyű","kit","adja","leszünk","segíts","látja","például","egészen","mindketten","apu","ölni","köszönjük","része","korábban","félek","édesem","szót","mondjuk","mennünk","tartani","élni","ketten","emberi","magukat","hagyja","ránk","dollár","számára","út","anyu","beszéltem","veszélyes","rögtön","tudjátok","kölyök","venni","tesz","mindenkit","kint","onnan","mondták","békén","hisz","körül","éjszaka","tiéd","látszik","ettől","merre","igazat","mármint","ház","kinek","fogják","fogjuk","szükség","feleségem","évvel","fordította","dehogy","gyertek","hozzád","szereti","régen","újabb","jót","adni","végig","hátra","kemény","biztonsági","jöttél","tegye","hihetetlen","amiért","segíthetek","picsába","anyád","lehetne","lányok","kifelé","meleg","szemét","kor","kerül","adott","esküszöm","tartsd","lássuk","fáj","ismered","utat","sajnos","mondtál","asszonyom","mai","kik","valahogy","jézus","érzed","helyen","hallom","titeket","város","tűnt","tudtad","lassan","bizony","véget","lehetett","éjt","család","napja","nyomás","víz","millió","éreztem","seggfej","senkit","hallani","mindannyian","ezer","beszélt","ismeri","bébi","csapat","nektek","távol","késő","került","halt","estét","keres","biztonságban","rólad","járt","amiket","tűz","szegény","kapott","maradjon","hoztam","érzés","csinálja","látok","valakinek","lányt","gondol","barátok","eléggé","magára","felesége","fia","mögött","okos","föld","senkinek","ülj","hölgyem","életét","szükséged","beszélj","peter","benned","hölgyeim","találkoztunk","egészet","ezredes","egyes","nyisd","ennél","egyébként","hozott","felejtsd","james","bocsi","bárcsak","vajon","sarah","csinált","megölni","annál","dolgozom","kislány","rengeteg","barátja","messze","közül","baja","itthon","napon","ugyanaz","köze","értelme","szeret","elmúlt","rég","hirtelen","bill","kérsz","jövő","keresel","legyek","beszélünk","tudnak","gondolok","városban","orvos","nevét","időben","kivéve","utoljára","lényeg","végén","mondanom","szeretne","értettem","vér","nézni","tartok","elmegyek","titkos","tábornok","aludni","nőt","szart","háború","fura","észre","szeretnél","életet","teszi","lehetetlen","játszani","gratulálok","szereted","talált","azóta","imádom","idióta","hiányzik","nyugodtan","büszke","üzenetet","hajó","kezd","folyton","hallgass","figyeljen","dolgom","adok","sötét","bajod","hír","világon","nálad","ám","játék","szállj","nézzétek","terv","nézzük","szerencsét","helyre","ideig","hagyjuk","látott","kap","fegyver","kutya","azután","oka","rosszabb","szét","drága","rendbe","fogalmam","hagyj","jutott","ilyesmi","megfelelő","hozd","legyél","normális","magas","csinálok","legközelebb","nyomozó","tudott","csodás","tettél","fasz","megölte","vidd","bizonyos","anyja","életed","lennél","akarják","számomra","hadnagy","önt","menjetek","szerelem","próbáltam","akivel","mehet","harmadik","általában","tehetek","állsz","gonosz","ennyit","szerettem","csináljuk","engedd","mennyit","mások","miközben","csomó","létezik","kár","évben","meghalni","bassza","mama","megértem","hívott","amivel","vel","elmondom","lányom","max","nyugalom","rajtam","óvatosan","siess","találni","and","hiszen","állt","mostanában","odakint","al","csináltál","nők","kék","ad","házban","egyenesen","utálom","miféle","henry","dollárt","érzi","hideg","segítsen","rájuk","beszélnünk","őszintén","hallottad","jut","kávét","éhes","úgyis","világos","kér","rajtad","állok","alapján","hmm","mondjam","óh","nála","őrmester","állunk","ebbe","hogyne","kétszer","földre","részt","világot","tennem","amúgy","maradni","vizet","évek","szinte","mondj","baszd","csinálod","maradok","mutasd","életemben","házat","elmondani","magadra","lettem","gyereket","hagyom","személyes","hiszek","kocsi","módon","évig","rendes","úristen","bocsánatot","emlékszik","fantasztikus","találkoztam","vörös","nevű","haragudj","kocsit","földön","szuper","szeretné","hívd","időnk","fent","kapd","hála","adtam","eljött","emiatt","hagyni","adta","üres","szemben","hacsak","doki","hívnak","kissé","kezét","hívj","mennek","szerelmes","megmondtam","barátod","fenét","bolond","várom","ügyet","állandóan","csaj","enni","hívja","gyors","csinos","közös","eszembe","élete","tartozik","zsaru","álljon","nyolc","régóta","éjszakát","mondjak","őszinte","zárva","többiek","sokan","dolgozott","óriási","időm","kicsoda","képet","abból","vette","meghal","finom","meddig","akarunk","hónapja","amely","kivel","lent","magunkat","nappal","mostantól","elé","férjem","teszem","történet","órát","próbáld","kedvenc","amiről","atyám","kapni","órája","hidd","közelebb","embernek","hagytam","foglak","lánya","bocsáss","szomorú","legtöbb","szeretek","félre","tudnám","franc","mondasz","igenis","kapsz","figyelem","kezed","baleset","percre","gyakran","ígérem","csinálom","balra","tök","ajtó","látlak","kedvesem","mester","valakivel","beszélnem","órán","hónap","áldozat","jöttünk","hibám","hozta","sohasem","itt","akartál","kezdődik","vegye","szólsz","mentem","nehogy","parancsnok","szükséges","név","hozzánk","szólj","átkozott","kezdjük","bíró","tartja","csinálta","jöttek","várjunk","könnyen","segítek","szeretsz","nálunk","kíváncsi","másodperc","örökké","nyugodj","hölgy","minél","olyat","hívni","neved","vezet","billy","jobbra","találkozni","látsz","csinálunk","szeretnéd","esik","valódi","valamilyen","pofa","dühös","tudná","tv","bobby","indulás","hagyta","aranyos","hinném","közt","terhes","maradsz","örökre","férje","mégsem","szerencsés","kevés","ismét","bármikor","lehetőség","nézek","esett","bal","hal","hallod","ölte","fickót","választ","akiket","com","elhinni","nyitva","hozni","semmilyen","rendőr","gyilkosság","különös","dehogynem","állat","ártatlan","biztonságos","vicc","korán","gyorsabban","jók","bármilyen","kérdést","pillanatban","rájöttem","tesó","közepén","tudnom","üzlet","szeretnénk","lehetsz","viccelsz","vett","kapok","önök","jane","üdvözlöm","fejét","lévő","szólt","asszony","rész","papa","katona","találtunk","szám","szívességet","főleg","tudna","véletlenül","megmondom","hinni","elől","bírom","adom","tartott","klassz","hátul","hallasz","mely","küldött","zöld","könyvet","mentek","esélyt","nevetséges","veszi","szobában","amiben","ötletem","remekül","nevet","hasonló","anélkül","hete","hagy","esetben","hiba","orvosi","csupán","tetszett","pokolba","hívom","nemsokára","baba","önnel","csináltad","oly","használni","élek","gép","lát","munkám","várni","ostoba","hozza","során","miattad","amik","hű","mik","mehetünk","önöket","jártam","évet","visszajövök","miben","vártam","bizonyíték","akarjuk","délután","ismerek","barát","egyszerre","válasz","kurvára","tartom","rövid","próbálok","hamar","szerelmére","mekkora","megtalálni","istennek","találtak","szemed","félsz","kérni","ügyes","bennünket","előző","tetted","felség","vált","időre","segítsek","barátaim","megnézem","hogyhogy","menned","akarlak","ideges","azelőtt","kértem","hátha","ribanc","buli","zsaruk","értek","segítséget","várjatok","várok","telefont","érdekli","lenned","elmenni","elmegyünk","elfelejtettem","némi","fáradt","indul","csináljak","tudnék","amilyen","keményen","láttalak","veletek","érzek","újság","film","láttál","által","helyett","sziasztok","helyi","örömmel","pete","börtönben","száz","élő","vinni","csoda","kellemes","tartsa","végeztem","halni","teszek","olvastam","kép","fogva","jöhet","csinálnak","felett","megölték","filmet","utcán","pasi","rohadék","segített","meglepetés","pillanatra","tuti","kórházban","keresek","nézzen","számodra","professzor","gazdag","jelenleg","embereknek","sőt","tudnád","hagyott","gyenge","férfiak","rendszer","örvendek","rosszat","írta","próbálom","testvér","katonai","dolgozol","fuss","tűnj","kapcsolat","kórházba","szex","családom","ellenére","meglátjuk","született","vacsora","mindenhol","igazságot","kormány","apró","mark","veszem","állnak","autó","életbe","idegen","francia","eljön","hiszik","halálra","híres","no","gyerekeket","családi","engedj","különösen","jel","húzd","hátsó","szoba","mihez","miattam","köztünk","alkalommal","további","bántani","ördög","akartok","forró","miatta","tegyek","könyv","üljön","aminek","bajban","előtte","nézett","tied","ország","hajót","legalábbis","magától","legfontosabb","csinálj","sört","mitől","börtönbe","ingyen","mérges","személyesen","friss","menjenek","kért","mért","szabadon","érkezett","hős","bizonyára","beszéltünk","hibát","tudnál","darab","pénzem","férfit","élve","zene","kisasszony","valamire","várost","illeti","állni","részeg","szólok","tartunk","ismertem","halála","egymás","bácsi","gondolj","keresem","bátor","kevesebb","kilenc","eleget","elmondta","menjek","matt","olyanok","vezető","körbe","fény","aznap","sikerül","tagja","kocsiban","megtaláltam","basszus","levelet","nézzék","amin","föl","hall","nyilván","ül","gáz","közé","érezni","lehetek","hajlandó","érdekében","megmutatom","készült","alkalom","lettél","törvény","képzelni","függ","találom","teszed","véletlen","elmegy","napig","mocskos","részét","kiváló","belső","piros","magadnak","ezúttal","mondanám","fele","magamnak","fő","legrosszabb","mehetek","egymással","szemem","bocsásson","levegőt","szerezni","lehetőséget","tüzet","tenned","túlságosan","perce","lássam","lehetnek","őrnagy","személy","angol","kelj","dolgoztam","lenyűgöző","hozom","fizetni","rendesen","nahát","beszéltél","kapcsolatba","beszélgetni","futás","dél","nevében","álom","kezem","különböző","várja","kevin","jöjjenek","alszik","bármelyik","fejem","tudd","hamis","telefon","művelsz","külön","tehetem","női","plusz","magányos","világban","dobd","gondolta","iskolába","fejezd","ellene","ügyvéd","szembe","adjon","végeztünk","iskola","tulajdonképpen","próbálja","durva","esély","ráadásul","írja","nincsen","ügyben","hitte","dns","járni","messzire","vegyél","ismer","akartad","fajta","kiderült","várunk","fiút","oldalon","ugyanazt","végzett","élt","megígérem","magához","képesek","fejed","tarts","továbbra","istenit","megtenni","hogyha","mindkét","zavar","inni","beszéljünk","figyeljetek","napra","cég","hm","legyünk","támadás","hazugság","szíves","keresünk","hozok","hahó","elmentem","szokott","hálás","barom","vezetni","ajándék","bátyám","óvatos","elmondtam","vért","hallottál","beszéljen","dolgod","keresni","autót","rendőrséget","lennem","ismersz","szél","hazudik","ezután","nővér","veszed","italt","parancsot","hülyeség","aggódjon","tökéletesen","várnak","elvesztettem","dolga","történni","orosz","súlyos","cserébe","bomba","szeretett","szeretni","ír","hiszel","elintézem","meglesz","kapcsolatot","odabent","sokszor","kínai","írni","csináljunk","szíve","herceg","válik","halálos","kérdeztem","élsz","másikat","mozdulj","élnek","faszt","játszik","írtam","hallotta","arany","hallott","megtettem","mindet","látjuk","miénk","kevésbé","legjobban","megtörtént","esti","írt","tenne","találta","simán","eset","köcsög","készül","találtál","ilyesmit","képest","tavaly","min","mindenre","megteszem","pasas","eredeti","beléd","természetes","rakás","őrület","undorító","könnyebb","német","mellé","máskor","tartozom","kettőt","bajom","elegem","elmész","ugyanúgy","aggódom","naná","kulcs","segítségre","sehol","legyenek","keresi","magáról","földet","egység","semmire","bízz","ahogyan","kérdezd","sor","sehova","kisebb","hívjon","nyilvánvalóan","gondolni","martin","vigye","felelős","hú","Amerika","ig","reméltem","talál","százados","ruhát","testvérem","tennünk","mindezt","akartalak","egyesült","nemrég","életemet","ismert","esélye","totál","hiába","fogadok","járok","bíróság","szüleim","igazgató","megpróbáltam","teszel","fordulj","igazam","megtaláljuk","pokol","övé","kaptunk","kezdtem","élünk","izé","hónapban","jelen","hercegnő","vigyázzon","mutatni","nemet","számot","miből","parancs","félj","fájdalmat","joey","üzleti","íme","ekkora","családja","elképesztő","barátnőm","hajrá","fontosabb","dögös","veszek","mindez","hivatalos","észak","hamarabb","szörnyen","kocsiba","nővel","húsz","gépet","üveg","táncolni","nemde","nagyi","szenátor","szobát","indulunk","képtelen","mehetsz","utánam","bízom","találták","megoldás","kezdett","ugyanolyan","hív","megmenteni","emberekkel","telt","feleséged","üzletet","hang","mennie","benneteket","idők","kapja","szabály","keresnek","szoktam","zenét","gondolkodtam","vesz","húzz","beszélnek","bonyolult","olvasni","követ","központ","szeme","szexi","szedd","azonban","megpróbálom","dolgunk","Krisztus","bajba","hagyják","tisztában","szólnál","irány","kizárt","feje","hívlak","arcát","hűha","elfoglalt","halottak","tisztán","büdös","harcolni","tegyük","szövetségi","errefelé","szerencse","tudtuk","épület","vetted","fájdalom","amennyire","szintén","néztem","iránt","mély","visszatért","figyeld","városba","hozz","amióta","különbség","megváltozott","ilyenkor","lennének","ezekkel","megvannak","múlik","egyetértek","számú","maguknak","fenn","lépés","kezdeni","tettek","folytasd","reggeli","engedje","célpont","döntöttem","nyissa","ajtón","éljen","ágyban","magáé","CIA","hadsereg","másképp","bűnös","használja","embere","hagyjon","hozzátok","vén","öcsém","szóljon","erősen","dolgozunk","mami","csendben","tény","kapcsold","show","mélyen","mögé","tőlünk","ellenség","másnak","ajándékot","féltem","erő","tudnod","szánalmas","magaddal","kezdődött","szexuális","emberei","hívták","csúnya","kerülni","azoknak","próbáljuk","unalmas","ruha","információt","ismerjük","kérdése","találnunk","akkora","segítesz","jársz","belőled","gondoltál","zsidó","elérni","tehetünk","mindegyik","maradunk","megnézni","öregem","ismerlek","öltem","értünk","asszem","lánnyal","látják","tegyen","hagyjátok","csinálják","szükségük","játékot","percig","értékelem","emberrel","feleségét","üzenet","kamera","jelentést","atya","disznó","tudnia","levegő","megtaláltuk","látták","olyasmi","vársz","nézzem","máshol","akárcsak","belőlem","parti","hármas","kedvéért","tartanak","utca","valamikor","órával","döntés","engedélyt","elveszett","megőrültél","iskolában","veszélyben","használd","edző","próbálj","képzeld","gyermek","bank","hányszor","hibád","titokban","szellem","profi","keressük","kezeket","vak","hajón","feledd","felügyelő","nélküled","kellenek","nyilvánvaló","lőni","vigyél","had","estére","szólva","csináltok","érzel","ifjú","folyamatosan","kuss","ütött","lennénk","küldte","tanár","anyag","helyzetben","mondanak","kövér","segged","utóbbi","fa","felnőtt","ismeretlen","egyelőre","módja","kim","nőket","hagyod","jutni","eszed","baromság","okés","kérdezni","nagyra","harcos","mondhatom","lábam","mellettem","kézzel","szöveg","háborút","követni","hétvégén","állást","tegyünk","tönkre","borzalmas","megértetted","nőnek","örök","fej","csendes","ébredj","amennyit","hívta","száma","megvolt","idáig","ugyanezt","karácsonyt","kulcsot","tegyél","tőlük","keresett","vasárnap","katonák","akiknek","nézzenek","nagyjából","tartozol","alak","szokásos","kerestem","hívtam","teát","érek","harc","magamat","tudnánk","habár","környéken","megsérült","sara","cucc","tudták","ötlete","megölöm","tudjam","seriff","mindennek","házba","találok","szeretik","megmondani","valamiféle","gyáva","lábad","hazudott","kaja","eszem","idős","meglátod","hónappal","felhívom","figyel","mentél","csoport","telefonon","kezdek","jelet","csupa","tartják","bolygó","ahová","változott","láttuk","oldalán","lefelé","állítja","pisztolyt","visszajön","fiad","életre","barátnője","döntést","kapta","útra","kérte","helyzetet","amelyik","magamra","hagytad","hazudsz","apámat","béke","próbál","ébren","életében","mindenütt","úgysem","fogalmad","pontos","vigyék","elviszem","döntött","találkozott","golyó","tanács","királynő","mára","labdát","közelében","elleni","szem","végső","teszünk","féltékeny","jövünk","test","megérteni","méter","induljunk","kínos","segíthet","jóképű","északi","megöltem","kitűnő","ismerte","buzi","valamelyik","semmiség","kettes","csakis","csapatot","ezeknek","szerette","hírek","tűnés","mesélj","kaptál","ismerős","mellesleg","egymásnak","vigyétek","szóba","magában","lehetünk","csajok","vacsorára","romantikus","megegyeztünk","hívtál","felirat","feleségül","hivatalosan","szív","magán","lépni","tanultam","barátai","kávé","országban","hétig","öngyilkos","illik","dupla","kiderül","őrültség","ámen","magammal","állapotban","éven","találja","tudtál","következik","megtalálta","rendőrök","előttem","kétlem","átlagos","megállítani","csakhogy","állami","srácot","megtiszteltetés","meghaltak","választásom","szálljon","hoztál","viszem","emlékezni","államok","izgalmas","befelé","vacsorázni","kutyát","kedved","szervusz","helye","sárga","jártál","kezdem","japán","nyert","körülbelül","elmondja","találd","néznek","korai","kezet","hasonlít","mellette","egyben","hívjuk","ex","negatív","értesz","beszéljek","kérdésem","kezében","szemmel","állítólag","ahova","isteni","hiányozni","akartak","manapság","dal","meghalok","beszélhetnénk","hó","útból","érdemes","hazug","válaszolj","napi","félig","várjanak","hazudtam","vétel","ekkor","legszebb","vihar","tégy","meló","menő","politikai","találjuk","béna","belém","állítsd","szerelmem","kaját","karácsony","nézem","elmentek","azokkal","park","okoz","szád","esélyünk","egészséges","angolul","hotel","bajt","fogjátok","végére","találunk","egyikük","munkája","mással","pompás","fizet","erősebb","tehet","csendet","történetet","találsz","keleti","állatok","eljöttél","vitte","hibája","valahova","legutóbb","elkapni","helyesen","kód","francot","perccel","hallgatni","picit","járnak","érkezik","halad","évesen","lettek","megöllek","telik","találkozzunk","félelem","izgatott","megteszi","hitted","déli","róluk","aludj","gyakorlatilag","házasság","lélek","tilos","használt","kedvelem","megvagy","levél","emlékezz","bizonyítékot","érez","móka","dalt","nemcsak","többször","amitől","szíved","méltó","fölött","teszik","házas","töltött","képeket","jönne","ablakon","rájött","kórház","dolgoznak","sült","bort","istenverte","azaz","teli","megkapja","vigyázni","régebben","nemzeti","doboz","másra","kedvem","problémát","nyerni","közelben","nyugodt","ágyba","halált","nehezen","gondolt","érezd","öröm","körülmények","titok","állam","tűnsz","valóság","buta","feküdj","megérkezett","végéig","hangja","ajánlom","elvesztette","negyedik","várt","érthető","okozta","mondanod","pohár","hozzák","öld","létre","magyar","többit","felvétel","rendkívül","banda","lény","meccs","voltatok","követtem","tesznek","pénzed","vad","megfelel","láb","megölt","sehová","maradjanak","percben","vacsorát","lépj","szülei","erőt","fegyvereket","fiát","viccelek","meghalsz","hallja","WC","fogtok","cél","héttel","állítani","tetszeni","keze","igent","tim","kellemetlen","találtuk","benn","amiatt","energia","adsz","utóbb","mód","nyitott","arc","ülni","tanulni","királyi","rock","vicceltem","bumm","holtan","mindenféle","játszunk","szerencsétlen","trükk","néni","repülni","férjhez","zseni","kezdve","sikeres","múltkor","lépett","ült","joga","irodában","nyoma","csend","lábát","melyet","megcsinálni","szabályok","USA","ijesztő","szűz","idősebb","nagyot","órára","címe","anyját","tudományos","háza","időd","kérünk","működött","sors","ismétlem","történelem","nyugodjon","jutunk","sürgős","nemzetközi","hallgasson","fogadni","információ","boldoggá","kezelni","lord","szívét","egyél","hús","percen","ősi","hallok","szabályokat","lennünk","rólunk","megtalálták","stimmel","háromszor","egyike","keresd","kapnak","ritka","indulj","tán","családod","működni","higgye","ahonnan","választás","fegyverek","hold","megjött","hívást","hatással","elvitte","figyelmet","folyó","vegyen","közülük","ahelyett","indulok","bosszút","eső","mesélt","magánál","irányba","barátnőd","miket","járunk","visszajött","fordul","tévedtem","boldogan","munkáját","gyanúsított","beszéltek","sérült","börtön","igyál","hagylak","szobába","bűn","néhányan","maradjatok","használ","megöli","bárhol","későn","madár","tanácsot","megpróbált","naponta","tették","figyelsz","visszamegyek","sztori","babát","nővérem","hívtak","eszik","dobja","darabig","fiamat","egymáshoz","bemutatom","segítene","felét","javaslom","védeni","alól","istenek","vonat","külső","extra","irányítani","hívás","megígértem","valószínű","vegyük","bejött","nyugati","idén","feleség","hónapig","kezdesz","tenném","bizonyítani","pénze","remény","megölted","olasz","adtál","teszt","program","fejemben","anyukád","lőtt","megteszek","lövés","menet","barna","szörnyeteg","adják","szabadság","olcsó","reméljük","adnak","erőszak","szaros","mondhatok","éltem","tegyék","ilyenek","jobbat","megvédeni","ételt","mentünk","érzésem","hozzájuk","polgármester","fényt","szeretet","szőke","esküvő","pálya","vészhelyzet","családot","keress","tesszük","emberünk","tévedsz","pénzzel","lép","látjátok","igyunk","fogalma","szokás","odalent","akarták","orvost","húgom","épületet","angyal","mondjon","teheted","verseny","hárman","vámpír","töltöttem","tenger","megkapod","beszélhetnék","nehezebb","suliban","rátok","jogi","légyszí","jele","vélem","áruló","szólni","nélkülem","munkára","művel","gondold","folytassa","sima","egyéb","melletted","kisfiú","melyek","szokatlan","cuccot","határozottan","törődj","álló","megkaptam","megcsinálom","tehetséges","pénzért","étel","derek","leginkább","hiányzol","származik","önöknek","hatalom","küldeni","idején","magatokat","írok","ereje","bejön","látnod","alacsony","tér","golyót","szerencsére","megöl","kapunk","megtudja","kegyetlen","beszéd","drog","megőrült","ló","értékes","eszedbe","gondoltad","takarodj","mer","megmentette","tartottam","vezetett","segítségével","bennük","nélküli","oldal","küldetés","enyémet","gondolkoztam","gondolják","elkezdett","lady","dehogyis","bárban","napom","helyére","elmondod","megpróbálta","fizetek","kelljen","feladat","nélküle","életünk","rajtunk","amerikaiak","vírus","all","hajnali","lányokat","macska","city","mondjátok","kapcsolja","ülök","cserben","sikert","kölcsön","változtatni","nyomd","okozott","férj","hazudtál","bánja","erőszakos","említette","mozogj","bölcs","forduljon","péntek","tennie","terület","alaposan","elhagyta","gyereke","akció","egyetem","km","ugorj","sör","ötleted","illegális","repülő","erdőben","ebéd","válni","terrorista","barátaid","szóltam","érzékeny","téved","számítottam","piszkos","tolvaj","dolláros","helyét","tudtok","elején","használják","számunkra","visszatér","seggét","emberem","megértette","kinyitni","egyértelmű","megállni","városi","szemétláda","embereim","napod","védelmi","lopott","közöm","szóló","mostanra","egyetemen","lánynak","rajtuk","randi","pilóta","marha","ettem","kéri","pokolban","szerzett","hírt","megkért","visz","találkoztál","megbeszéltük","mozduljon","rendszert","aludtam","győzni","bűnöző","orvosok","anyámat","változik","hányan","mozog","használta","egyfajta","hátrébb","higgy","szörny","biztosra","ellopta","helyén","engedjen","feltétlenül","bárkit","fájt","bírja","háborúban","figyelembe","Amerikában","lélegezz","mérföldre","suli","szereztem","feltételezem","természet","mutat","donna","mondtak","titkot","ára","tartasz","asztal","bármire","akarjátok","futni","szívás","arca","készülj","nép","nocsak","halljuk","akármi","listát","játszol","amelyek","halálát","megtalálja","hiányoztál","féle","részek","parton","egyikünk","szomszéd","csapda","szigeten","kezdünk","patkány","időzítés","iszom","kel","közelébe","követett","jönnöd","kérjük","központi","szerinte","társam","robbanás","szel","korábbi","hangot","másodszor","segítened","borzasztó","holnapra","megtudni","lejárt","mérföld","szüleid","vezetője","rák","találnom","menteni","lefogadom","pontot","viccel","valamiben","bombát","elhagyott","nyáron","látnom","számát","majom","írd","közvetlenül","álmodtam","pap","műsor","lőttek","fal","gordon","napján","látnak","fiatalember","pöcs","érni","köztük","munkád","anyagot","iroda","véve","legyetek","senkivel","történhetett","tévében","szavak","zsarukat","nyertem","testet","kéz","rájön","testét","alszom","tudhatod","tartjuk","ismerik","társaság","mindkettő","énekelni","játszom","lakás","felhívott","justin","keveset","tűnjünk","fegyveres","játékos","ágy","tiszt","győzelem","maradjunk","nemes","sötétben","energiát","abszolút","megkapta","suliba","érj","pihenj","alkalmas","kelet","végezni","hibás","kapjuk","író","lányát","hasznos","házi","veszély","foglalkozik","lépést","hívtalak","beszélhetek","megtalálom","fizetett","kérdésre","náluk","pénzét","önző","beleértve","akarna","csillag","vigyük","végeztél","adtak","törvényt","baszki","számos","elviselni","elektromos","nyom","hajad","valakire","valamivel","valahová","pályán","történhet","emberiség","betegség","húst","küldtek","démon","fekszik","magadat","csináltak","csukd","segítsenek","kérnék","magunk","jesszusom","áldozatot","meccset","lakom","előttünk","érünk","szerezted","érezte","megbeszéljük","kibaszottul","gyűrű","figyelni","várjuk","évre","elégedett","csajt","lehetnék","tehetsz","lépjen","láttunk","mutatja","beszélgettünk","anyádat","karácsonyi","tartod","állandó","pillanatot","kést","pajtás","vízbe","bajnok","robot","bátyád","csapdába","őr","teste","osztály","pisztoly","konyhában","mexikói","blah","pici","sikerülni","emlékeztet","veszik","évad","tisztességes","süket","egyből","emeleten","gondot","érteni","apját","jegyet","aggódik","helyette","máshogy","tartalmából","semmiféle","tölteni","mindenesetre","vesszük","földi","ölt","ölték","szinten","kapaszkodj","kerülsz","vigyen","hétre","másnap","tévedés","bennünk","hagyhatom","küld","gondoltuk","lányod","szerzek","boldogok","lakást","rendkívüli","sétálni","mindössze","híreket","újat","akárki","önre","gyerekeknek","szombaton","férjed","ígérd","maradnak","bulit","parkban","viszi","véres","célja","indult","szeretnek","sziget","szándékosan","érdekelne","születtem","álltam","fegyvere","fair","elfelejteni","nagyszerűen","Jesszus","magasabb","játszott","hozzon","gombot","rémes","vennem","odafent","kb.","megnézzük","ugyanis","kaput","kié","barátunk","szarházi","adjuk","rúgva","tervem","elképzelni","hulla","típus","gondolat","est","tennék","brit","belőlük","küldtem","tervet","megláttam","közvetlen","tucat","engedély","iszik","változás","nyílt","pénteken","lám","éjszakára","kő","látható","beszélgetés","gyógyszert","keresik","ülsz","akiről","országot","felejtse","alszol","kört","megpróbál","hölgyek","egyetemre","mondhatnék","másfél","gyermekem","fickók","labda","valóra","fordítás","ittam","tánc","vigyázok","tesztet","ilyeneket","arrébb","gyűrűt","meghalunk","kérj","tudlak","néven","nyugton","próbált","esze","vettél","fordult","kussolj","megszökött","kocsiból","innét","haldoklik","vezeti","vére","hali","érnek","frászt","órában","szólna","apádat","öné","közeledik","jártunk","hittük","lőj","bemegyek","modern","papír","kérdezhetek","megtörténik","ölj","városból","sorban","szavakat","megkeresem","arcod","években","lehető","napok","nyugat","kinn","épületben","lába","életedben","felső","félnek","picsa","bájos","tengeri","csináltunk","csirke","híd","képek","akire","hazudni","hallgasd","Isten","vették","sofőr","szállt","nesze","éjszakai","ugyanakkor","ura","tettünk","szemembe","adunk","szünetet","megkaptad","magukkal","csávó","felkészülni","tenné","elvette","mértékben","perverz","megtette","zseniális","bátyja","tűnjön","kör","lődd","meglepő","nyer","szemébe","világnak","szigorúan","bánni","fedélzeten","álljanak","elkapjuk","félelmetes","kígyó","sütit","dologra","helyszínen","jelentés","gyerekem","rádió","húzza","jelentsen","nyúlj","fizetnek","adhatok","jég","ébresztő","előtted","látunk","megvagyok","mutassa","forog","könyörgöm","miniszter","esélyed","szülinapot","gyilkossági","időbe","haja","támadt","jóval","írva","utánad","hoztad","veszel","felhívtam","sötétség","haltak","tisztelettel","közeli","biztonság","ellenséges","szemetet","apuci","akkoriban","boszorkány","legenda","területet","virágot","folytatjuk","kutyák","fényes","kaphatnék","szabadna","furcsán","akármit","spanyol","telefonált","munkámat","házam","cím","elkezdtem","kölykök","testvére","cuki","elmentél","ronda","elvitték","kerültem","elnöke","baseball","egymásra","megéri","rendet","vonal","találnak","okot","terved","háborús","jónak","faszom","mennék","fegyverrel","fok","szombat","mindenről","csinálnom","műtét","elmondtad","őfelsége","menne","évekig","busz","bánod","hiányzott","anyukám","templom","agy","valamint","küldje","faszfej","árt","tudós","jelentett","ötös","ameddig","számlát","végét","miami","olvasd","testvérek","láttak","aggódtam","terve","csomag","helyzetbe","idejét","főnöke","kívánom","küldd","készítette","barátomat","címet","hazamegyek","eladni","akárhogy","legutóbbi","úszni","sárkány","fák","gondolkozz","kocsim","idővel","nőtt","maradtam","ellenem","tegyem","húzzunk","öcsi","akartunk","többen","elvesztettük","ügyében","lista","álmom","klub","fogni","partra","csekket","vizsgálat","lassú","emeld","katasztrófa","házában","jövőben","történtek","szeretjük","választott","szívi","valamiért","seggem","jelenlegi","találkozom","adag","ötödik","próbálta","házasok","teheti","ajánlatot","dolcsi","fogadja","asztalt","taxi","szerezte","pozitív","aggódsz","adod","beszélhetünk","térkép","tudomány","véleményem","viselkedik","aggódni","engedjenek","bánt","kérdezte","ital","gyűlölöm","hátam","vád","kiló","heti","tartotta","Párizsban","négyes","lesztek","örültem","északra","szóltál","megtaláltad","szégyen","jelenteni","szobájában","díjat","tűnnek","álljunk","láttátok","illetve","hihetetlenül","téma","klasszikus","jövőre","amelyet","éri","lányomat","tűnés","méghozzá","szerezz","itteni","lépcsőn","fejjel","elnököt","nős","meztelen","melót","rendőrségi","megnéztem","többieket","hírem","maradhat","köszönni","kísérlet","szállni","legújabb","kocsival","bor","rettenetes","általános","hagyjál","Londonban","legjobbat","lila","megpróbálja","lássa","hangosan","színész","eljárás","várják","halok","aludt","órás","útban","sztár","csók","állati","számítógép","ügyvédet","nyomja","tanú","tag","mindenben","segítettem","vigyáz","listán","fizikai","felvételt","bolygón","kapjátok","laksz","észrevettem","rablás","koromban","tört","elkapták","felvenni","akikkel","kamerát","magunkra","fájni","italra","vendég","családját","szórakozni","pofád","engedem","esni","fájdalmas","pénzügyi","tárgyalás","kapod","elviszlek","békét","történne","iszol","áldozatok","bíróságon","kitől","repül","mindenképpen","kényelmes","könyörgök","beszélgetünk","véleménye","amihez","elmondjam","békében","vezetek","térdre","kezdte","eltűntek","hétfőn","művész","házból","boltban","odaát","megértettem","száll","engedi","halat","jutnunk","tudtak","bizottság","hozhatok","zárd","gondolkodni","foglaljon","oldalt","értük","áron","értitek","eltűnik","sztorit","törődik","egek","nigger","kapom","farkas","darabokra","lelőtték","találtad","fickónak","akarná","pajti","fejében","papírokat","csináljon","veszünk","működnek","felejtettem","imádni","hívsz","megadom","iskolai","kerestek","univerzum","harci","ablakot","szebb","nyilvános","állás","kém","kódot","kés","eredmény","nyomot","csúnyán","hajóra","egyértelműen","meglehetősen","hazudok","bánom","kárt","hagyhatjuk","többre","előtti","hármat","támadást","kapcsolatos","műsort","mibe","medve","nézzetek","vitték","tért","táskát","bőven","falat","utal","mókás","mennyibe","templomba","elfelejtetted","érdekelt","éles","hangját","használjuk","nyomozás","magyarázat","beszélgetést","vágod","végez","témát","állítsa","jelentkezz","gyanús","így","sráccal","emberre","párat","negyed","nulla","urat","kérdezem","védelem","császár","áruld","taxit","illata","eszel","történjen","köszönhetően","kedvencem","alkut","nyomorult","férfival","hetes","óceán","megoldom","erejét","gondoljuk","milliót","kocsija","olyasmit","esélyem","esetre","miről","hotelben","nukleáris","megölnek","istent","viselkedsz","azokra","elfogadom","fickóval","kora","csésze","alku","délre","vegyék","halljam","kérdezi","befejeztem","abbahagyni","megbízható","bőr","nézve","felelősséget","megtörténni","törni","megpróbálok","gondolkodom","kapu","gyerekekkel","ezekben","koncentrálj","fiatalok","hetet","közülünk","képen","magáért","per","kezdet","evett","faj","vonalban","eljössz","áh","állapota","felesleges","sír","gépen","dolgokra","szerződést","rájönni","egyfolytában","mindannyiunkat","éltek","közöd","nagyapa","ken","gyorsabb","idegenek","gondolnak","mutassam","eszébe","vesznek","tudnunk","nemi","józan","fest","ritkán","beszéljük","vízben","tetején","csalódást","lenn","utazás","megoldást","meghalnak","anyát","haj","részem","választásunk","találod","gazember","speciális","területen","száraz","fejedben","lelépett","ragyogó","fasza","vettek","tehetnék","kíván","oldalra","falu","álljatok","meglátja","becsületes","kaptak","terveztem","visszahívlak","oldani","sue","értik","vásárolni","agya","hangzott","játszottam","igazságos","ezüst","fut","megcsináltuk","megtalálják","civil","törött","hoppá","tömeg","római","legközelebbi","elfogyott","egyiket","kérdezze","megteszed","válaszol","nyomozást","találkozik","elveszíteni","száját","végtelen","gyógyszer","csillagok","jönnie","válaszoljon","igyekszem","lelki","hatása","főnököm","bízol","szarok","helikopter","tegyétek","adjak","helyettes","tea","szóra","mondaná","története","seb","okozni","üsd","ivott","lyuk","megengedi","pénzre","bármely","drogot","tetszene","részvétem","megérted","választotta","zavarja","önért","négyszemközt","játszanak","vesztes","pokoli","íze","királya","szövetség","kimegyek","megkérdeztem","égnek","megoldani","one","semmivel","tutira","sírni","kedvellek","németek","mindennap","hagysz","vágni","jelentős","hallgatom","hazafelé","dobozt","szoros","részben","figyelmét","használtam","történnek","egyenes","megtennéd","milliárd","hagytál","dologban","meséltem","gyilkosságot","foglalt","csapatban","elhagyni","vettük","kettesben","érsz","kedve","intézni","kard","mindenképp","font","tévedek","próbálni","dolgokról","megjelent","utcára","sarkon","másokat","elbűvölő","szerencsém","kettőnk","kérnem","palmer","szendvicset","szenved","ravaszt","megérti","akartuk","egyetemi","tehettem","beszédet","egyedülálló","lelőtte","szint","szülők","tudtunk","modell","húzni","görög","hülyeséget","férjét","szerepel","engedhetem","találják","harminc","amilyennek","magyarázni","követi","vitt","elkapta","sajtó","utáni","állomás","héj","fejbe","győztes","erősítést","szünet","hajam","helyedben","folytatni","félreértés","összesen","szoktál","fiúkat","templomban","szenvedett","verni","értelemben","soká","hoztak","szarban","nézed","nézzünk","rakd","félt","lakott","motor","élőben","magunknak","meztelenül","varázsló","irányítást","vinnünk","bírod","problémája","számok","meglátom","gyalog","gyereknek","apámnak","tanult","tejet","dagadt","nyúl","lassíts","testem","segítenek","maradjak","bosszú","öngyilkosság","hallgat","bárkinek","lelke","évente","vérzik","testvéred","szerencséd","szarul","egyesek","elfogadni","alakult","bízik","elindult","hülyének","életünket","érdekelnek","csináltuk","emelet","felfelé","szoktak","mérget","urak","őrök","elérhető","készített","szórakozást","papírt","anyának","biztosak","helyem","eszünk","gépek","mondhatod","lejjebb","kérdezzek","leesett","kötni","megtanultam","szer","megoldjuk","férfinak","méreg","időkben","ültem","jártak","ablak","por","mégse","falon","apát","von","szerepet","képtelenség","edd","veszélybe","méterre","jen","kedvel","adták","apádnak","adatokat","ajánlat","nyári","szépség","tisztára","kent","klubban","hagyjatok","végzek","feleségemet","kiment","azonnali","lámpát","bújj","bámulatos","eressz","meghaltál","fogadd","filmben","lettünk","csinálnunk","imádja","fér","meghaltam","öntől","párszor","kitalálni","dolgát","házamban","áram","úriember","néztek","rémálom","kezemben","légi","helytelen","agyam","örülni","birodalom","eltört","kulcsa","megcsináltad","alfa","irodájában","kockázatot","akadt","gondom","csatorna","go","kocsiját","hátulról","hozzuk","elhiszem","érzelmi","perced","néznem","dönt","dologról","készülsz","fát","öl","ismerni","kértek","segítségére","szaga","mindenkivel","engedjék","megkérdezem","kaphatok","bűnösnek","hit","megölik","aludtál","tojás","jövőt","fiatalabb","szavamat","század","örülnék","hallottuk","bunkó","elkaptam","céget","pezsgőt","darabot","segítsetek","addigra","elkezdődött","jutottam","problémám","világra","küldök","árulja","zárt","mindnyájan","adjunk","kormányzó","megköszönni","csinálnod","mindannyiunknak","válaszolni","tartson","rózsaszín","tévét","társa","fox","kerülnek","biztosíthatom","eggyel","jóban","munkába","kérdéseket","sírj","láthatatlan","mutatok","olaj","finoman","csináljátok","vizsgálatot","léteznek","kívánok","figyeljenek","változtat","kapják","hallak","olvassa","kötött","hatos","élvezni","rejtett","próba","mocsok","találkozásnak","vadász","véleményed","szerelmet","jelentkezett","fúj","kifejezés","küldi","megcsináltam","zavart","fertőzés","vágd","szürke","évekkel","veszett","órakor","visszajöttem","vigyázzatok","figyelek","kártyát","kislányom","bácsikám","átok","újságot","visel","adtad","választottam","utcai","irodába","átadom","mars","reggelit","lefeküdni","eljönni","pizzát","békés","segítségedre","hitt","ezekre","közlegény","nézi","szórakoztató","ütés","ügyön","mögötted","ellopták","jói","volnék","virág","figyeltem","maradék","bravó","étterem","sorba","előlem","esküvői","veszélyt","készítettem","vonzó","reményt","csomagot","részleteket","gondja","illetően","mintát","szerető","vádat","remélhetőleg","kerüljön","határ","aggódnod","köszönet","varázslat","törvényes","szellemek","értette","istenre","hozták","ügyész","moziba","akad","nyitni","meglehet","fölé","elöl","ötven","csaló","vállalat","segítünk","haverom","utálja","szeretünk","bolt","versenyt","kezdenek","mindkettőt","admirális","hozol","határt","feladatot","lények","hűséges","közénk","apának","lassabban","oroszok","tanítani","kezekkel","késni","csúcs","található","ezennel","elkaptuk","kénytelen","melyiket","levegőben","vidám","édesanyád","jóvá","tojást","tartó","leszarom","hívod","pillantást","módszer","rendőrségnek","mindenem","követte","helyben","teremben","szórakozol","lényege","lyukat","várhat","formában","eljöttek"];
var STOPWORD = {
                        "it": STOPWORDS_IT,
                        "hu": STOPWORDS_HU,
                        //"en": STOPWORDS_AM,
...
browser.commands.onCommand.addListener(function(command) {
    if (command == "add-selected") {
            ...
            browser.tabs.query({ currentWindow: true, active: true}).then(sendAddStopToTab).catch(onError);
            console.log("add-stop word event!");
     }
});
...
function sendAddStopToTab(tabsData){
    browser.tabs.sendMessage(tabsData[0]['id'], {"func": "addStop"});
}
...
function storeWord(payload){
    console.log("payload is ", payload);
    payload['wordData']['wordType'] = 'history';
    browser.storage.local.set({ [payload["word"]] : payload['wordData'] });
}

function getContexts(text, tokens){
    var sentences = Sbd.sentences(text);
    var contextDict = new Object;
	...
	for (var i = 0; i < tokens.length; i++) {
      ...
      var colorSents = blackSents.map(function(sent) {
          return sent.replace(replace_regex, replaceWith);
      });
      contextDict[token] = colorSents;
	}

    console.log('for ' + tokens.length + ' tokens, we have contextDict ', contextDict);
    return contextDict;
}
...
function sendColorWords(payload, sender){
    ...
    var clean_token_prom = filterStopWords(tokens_noproper.map(x => x.toLowerCase()),lang_det);
    clean_token_prom.then(function(clean_tokens){
        ...
        storedItemsPromise.then((results) => {
            ...
            console.log('searching for history words. All words saved: ', historyWords);
            for (let historyWord of historyWords) {
                var wordData = results[historyWord];
                // make sure it's history word and NOT stop
                if(wordData['wordType'] == 'history'){
            ...
            browser.tabs.sendMessage(sender['tab']['id'], {"func": "highlight", "toHighlight": words.slice(0,100),"wordRankDict": counts, "foundHistoryWords": foundHistoryWords, "contextDict": contextDict, "lang": lang_det});
        }, onError);
    });
}
...
function filterStopWords(words, lang){
    ...
    return storedItemsPromise.then((results) => {
        var allWords = Object.keys(results);
        console.log('searching for STOP words ', allWords);
        return allWords.filter(function(word){ return results[word]['wordType'] == 'stop';});
    }, onError).then( (stops) => {
        console.log("Saved stop words ", stops);
        var language = lang.toLowerCase().slice(0,2);
        console.log(STOPWORD);
        return words.filter(x => !(STOPWORD[language].includes(x)|STOPWORDS_AM.includes(x)|TOP1000[language].includes(x)| stops.includes(x)|x.length < 3));
    }, onError);
}
...
var trigram = __webpack_require__(8).trigram;
